...
\usepackage{setspace}
\singlespacing
\setlist{nolistsep,itemsep=0cm,parsep=0pt,leftmargin=1.8cm}
\setlist[enumerate]{nolistsep,itemsep=0cm,parsep=0pt,leftmargin=2cm}
\parindent=1.5cm
...
\DeclareCaptionFormat{fmt}{\parbox{\linewidth}{\hspace{15mm}#1#2#3}}
